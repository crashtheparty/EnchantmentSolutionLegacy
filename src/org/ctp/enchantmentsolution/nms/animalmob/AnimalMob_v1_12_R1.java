...
public class AnimalMob_v1_12_R1 extends AnimalMob{
	
	private Variant parrotVariant;
	private Color llamaColor;
	private int llamaStrength;

	public AnimalMob_v1_12_R1(Animals mob, ItemStack item) {
		super(mob, item);
	...
	public static AnimalMob createFromConfig(YamlConfig config, int i) {
		AnimalMob_v1_12_R1 mob = new AnimalMob_v1_12_R1();
