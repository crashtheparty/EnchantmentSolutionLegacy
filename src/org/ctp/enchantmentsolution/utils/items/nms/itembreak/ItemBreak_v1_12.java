	...
	private List<Material> getItemBreakTypes(Material type){
		...
		case WOOD_PICKAXE:
			itemTypes.addAll(Arrays.asList(Material.ICE, Material.PACKED_ICE, Material.FROSTED_ICE, Material.REDSTONE_BLOCK, Material.IRON_BARDING, 
					...
					Material.QUARTZ_BLOCK, Material.BRICK, Material.COAL_ORE, Material.COBBLESTONE, Material.COBBLE_WALL, Material.CONCRETE, 
					Material.ENDER_STONE, Material.BLACK_GLAZED_TERRACOTTA, 
		...
		case WOOD_SPADE:
			itemTypes.addAll(Arrays.asList(Material.CLAY, Material.DIRT, Material.GRASS, Material.GRAVEL, 
					Material.SAND, Material.SOUL_SAND, Material.CONCRETE_POWDER));
			return itemTypes;
		default:
			break;
		}
